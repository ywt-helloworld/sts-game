...
public:
    ...
    [[nodiscard]] const sf::Texture* hudTextureFor(HudIconKind kind) const noexcept;
...
private:
    ...
    [[nodiscard]] const sf::Texture* loadHudTexture(HudIconKind kind);
    ...
    std::array<const sf::Texture*, 5> hudTextures_{};
